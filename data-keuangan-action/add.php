                ...
                <div class="card-body">
                  ...
                  <label for="user">user</label> 
                     ...
                     <?php
                      ...
                      <div class="mt-2 mb-2 text-white">
                        <label for="">Uangkas</label>
                        <input type="number" name="uang" class="form-control" id="">
                      
                      </div>
                      <div class="mt-2 mb-2 text-white">
                        <label for="">Nomor Absen</label>
                        <select name="absen" class="form-control" id="">
                         ...
                         <p class="text-secondary"><font class="text-info">info : </font>Jika sudah perna dimasuki nomor absen tidak perlu dimasuki lagi tinggal di kasih input di kosongin aja!</p>
                      </div>
                       <div class="mt-2 mb-2 text-white">
                        <label for="">masukan_id_absen</label>
                        <select name="absen_id" class="form-control" id="">
                          <?php
                          for($i=1; $i<=30; $i++){
                          ?>
                          <option value="<?= $i;?>"><?= $i;?></option>
                        ...
                        <p class="text-secondary"><font class="text-info">info : </font>sesuaikan dengan absen sebelumnya atau absen yang baru mau di masukin!</p>
                      </div>
