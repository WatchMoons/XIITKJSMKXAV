...
if(!isset($_SERVER["PATH_INFO"])=="dashboard-article.php"){
...
if( isset($_POST["cari"] )) {
    $data = cariarticle($_POST['keyword_article']);
}
...
<html lang="en">
  <head>
    ...
    <title>XII TKJ | dashboard article</title>
    <link
      ...
      <div class="d-flex">
        ...
        <nav class="navbar p-10 navbar-dark">
          ...
          <div class="content h-75">
            <div class="container-fluid">
              <div class="title">
                <h1 class="text-white ms-3 mt-3 mb-3">Dashboard Article</h1>
              </div>
              <div class="row mt-5 ms-lg-3 me-lg-3">
                <div class="container">
                  <a
                    class="btn btn-success col-lg-3"
                    href="article-action/created.html"
                    >+ ADD NEW ARTICLE</a
                  >
                </div>
              </div>
              <div class="col-12" style="overflow: auto">
                <div class="row mt-5 ms-lg-3 me-lg-3">
                  <form action="" method="POST" class="d-flex">
                    <input type="search" name="keyword_article" id="keyword" class="form-control" >
                  ...
                  <table class="table text-white">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Isi Article</th>
                        <th scope="col">Waktu Pengguhan</th>
                  ...
                  <?php        
                  $id=$row["id_user"];
                  $dataawal=mysqli_query($conn, "SELECT * FROM tb_user WHERE id='$id'");
                  $show=mysqli_fetch_assoc($dataawal);
                  ?>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?= $row["article"];?></td>
                        <td><?= $row["waktu_ pengunggahan"]?></td>
                        <td>
                          <a href="article-action/edit.php?id=<?= $row["id"]; ?>">edit</a>
                          <a href="article-action/delete.php?id=<?= $row["id"]; ?>" onclick="return confirm('yakin?');">delete</a>
                        </td>
                      </tr>
                    </tbody>
                    <?php $i++; ?>
          ...
          <div class="container mb-auto mt-5">
            <footer class=" text-white border-top">
              <p class="text-center">copyright &copy; by Tanhanho</p>
            </footer>
          </div>
        </div>
      </div>
