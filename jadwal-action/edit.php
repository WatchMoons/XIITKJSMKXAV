...
$id=$_GET["id"];
$data = query("SELECT * FROM tb_jadwal WHERE id='$id'")[0];
if(isset($_POST["save"])){
               ...
               <table class="table text-white ">
                  <thead>
                    <tr>
                      <th scope="col">#</th>
                      <th>hari</th>
                      <td><input type="text" class="form-control bg-secondary text-white" name="hari" value="<?= $data["hari"]; ?>"></td>
                    </tr>
                    <tr>
                      <th scope="col">#</th>
                      <th>Nama_Maple</th>
                      <td><input type="text" class="form-control bg-secondary text-white" name="nama_maple" value="<?= $data["nama_maple"]; ?>"></td>
                    </tr>
                    <tr>
                      <th scope="col">#</th>
                      <th>Nama_Guru</th>
                      <td><input type="text" class="form-control bg-secondary text-white" name="nama_guru" value="<?= $data["nama_guru"]; ?>"></td>
                    </tr>
                    <tr>
                      <th scope="col">#</th>
                      <th>jamke</th>
                      <td>
                        <input type="text" name="jamke" class="form-control bg-secondary text-white" value="<?= $data["jamke"];?>">                   
                      </td>
                    </tr>
                    <tr>
                      <th scope="col">#</th>
                      ...
                      <td>
                        ...
                        <option value="<?= $data["id_time"];?>"><?= $data["id_time"]; ?></option>
                        <?php 
                        $i=10;
                        for($i=1; $i <= 20; $i++) :
                        ?>
