...
$jumlahData =count(query("SELECT * FROM tb_jadwal"));
...
//data siswa
    $data = query("SELECT * FROM tb_jadwal LIMIT $awalData,$jumlahDataPerHalaman");
if( isset($_POST["cari"] )) {
    $data = carijadwal($_POST['keyword_jadwal']);
}
if(!isset($_SERVER["PATH_INFO"])=="dashboard-jadwal.php"){
      ...
      <div class="d-flex">
        ...
        <div class="w-100">
          ...
          <div class="content">
            <div class="container-fluid">
              <div class="title">
                <h1 class="text-white ms-3 mt-3 mb-3">Dashboard jadwal</h1>
              </div>
              <div class="row mt-5 ms-lg-3 me-lg-3">
                <div class="container">
                  <a class="btn btn-success col-lg-2" href="jadwal-action/created.php">
                    + Tambah Jadwal Baru
                    </a>
                </div>
              </div>
                  ...
                  <table class="table text-white">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><?= $row["id_time"];?></td>
                        <td>
                          <a href="jadwal-action/edit.php?id=<?= $row["id"];?>">edit</a>
                          <a href="jadwal-action/delete.php?id=<?= $row["id"];?>" onclick="return confirm('yakin?');" >delete</a>
                        </td>
                      </tr>
                    </tbody>
                    <?php
