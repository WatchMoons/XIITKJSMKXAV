...
$id=$_GET["id"];
$data = query("SELECT * FROM tb_banner WHERE id='$id'")[0];
if(isset($_POST["save"])){
      ...
      <div class="d-flex">
        ...
        <div class="w-100">
          ...
          <div class="content mt-4">
            <div class="container">
              <div class="row">
                <h1 class="text-center text-white"><?= $data["judul"]; ?> </h1>
                <div class="m-auto " 
                style=" 
                height:100px;
                width:100px;
               ...
               <table class="table text-white ">
                  <thead>
                    <tr>
                      <th scope="col">#</th>
                      <th>judul</th>
                      <td><input type="text" class="form-control bg-secondary text-white" name="judul" value="<?= $data["judul"]; ?>"></td>
                    </tr> 
                     <tr>
                      <th scope="col">#</th>
                      <th>gambar </th>
                     ...
                     <tr>
                      ...
                      <td>: <input type="hidden" name="time" value='<?= $data["tanggal_post"]; ?>'> <?= $data["tanggal_post"]; ?></td>
                    </tr>
                    <tr>
