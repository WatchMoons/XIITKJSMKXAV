...
if(!isset($_SERVER["PATH_INFO"])=="dashboard-banner.php"){
 header("location: dashboard-banner");
 exit;
}
    $jumlahDataPerHalaman = 6;
    $jumlahData =count(query("SELECT * FROM tb_banner"));
    ...
    //data siswa
    $data = query("SELECT * FROM tb_banner LIMIT $awalData, $jumlahDataPerHalaman");
if( isset($_POST["cari"] )) {
    $data = caribanner($_POST['keyword_banner']);
}
...
<html lang="en">
  <head>
    ...
    <title>XII TKJ | dashboard Banner</title>
    <link
        ...
        <div class="w-100">
         <nav class="navbar p-10 navbar-dark">
          ...
          <div class="content">
            <div class="container-fluid">
              <div class="title">
                <h1 class="text-white ms-3 mt-3 mb-3">Dashboard Banner</h1>
              </div>
              <div class="row mt-5 ms-lg-3 me-lg-3">
                <div class="container">
                  <a class="btn btn-success col-lg-2" href="Banner-action/created.php"
                    >+ ADD NEW BANNER</a
                  >
                </div>
              </div>
              <div class="col-12" style="overflow: auto">
                <div class="row mt-5 ms-lg-3 me-lg-3">
                  <form action="" method="POST" class="d-flex">
                    <input type="search" name="keyword_banner" id="keyword" class="form-control" >
                  ...
                  ?> 
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th scope="row"><?= $i; ?></th>
                        <td><?= $row["judul"]; ?></td>
                        <td><img src="foto/<?= $row["gambar"];?>" alt="" width="40px"></td>
                        <td><?= $row["tanggal_post"]?></td>
                        <td>
                          <a href="banner-action/edit.php?id=<?= $row["id"]; ?>">edit</a>
                          <a href="banner-action/delete.php?id=<?= $row["id"]; ?>" onclick="return confirm('yakin?');">delete</a>
                        </td>
                      </tr>
                    </tbody>
                    <?php $i++; ?>
